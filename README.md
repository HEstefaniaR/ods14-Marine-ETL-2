...
<p align="center">
  <img src="./images/etl_pipeline.png" width="750"/>
</p>
...
### 5️⃣ Run the Airflow DAG manually
In the Airflow UI (`localhost:8080`):

- Enable DAG: `etl_ods14_marine_life`
- Trigger it once to execute the full pipeline.
